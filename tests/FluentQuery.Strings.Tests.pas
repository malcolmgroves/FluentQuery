...
initialization
  ...
  RegisterTest('String/TStrings', TestTQueryTStrings.Suite);
  RegisterTest('String/TList<String>', TestTQueryString.Suite);
  RegisterTest('String/StringPredicate', TestFluentStringPredicate.Suite);
end.
