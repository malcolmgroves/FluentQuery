...
begin
  CheckEquals(FIntegerCollection.Count, IntegerQuery.From(FIntegerCollection).Take(FIntegerCollection.Count).Count);
end;

procedure TestTQueryInteger.TestTakeGreaterThanCount;
begin
  CheckEquals(FIntegerCollection.Count, IntegerQuery.From(FIntegerCollection).Take(FIntegerCollection.Count + 1).Count);
end;

procedure TestTQueryInteger.TestTakeLowerThanCount;
begin
  CheckEquals(FIntegerCollection.Count - 1, IntegerQuery.From(FIntegerCollection).Take(FIntegerCollection.Count - 1).Count);
end;

procedure TestTQueryInteger.TestTakeUntil;
begin
  CheckEquals(8, IntegerQuery.From(FIntegerCollection).TakeUntil(9).Count);
end;

procedure TestTQueryInteger.TestTakeUntilUnboundQuery;
begin
  CheckEquals(8, IntegerQuery.From(FIntegerCollection).TakeUntil(IntegerQuery.Equals(9)).Count);
end;

procedure TestTQueryInteger.TestTakeWhere;
begin
  CheckEquals(2, IntegerQuery.From(FIntegerCollection).Take(5).Where(FEvenNumbers).Count);
end;

procedure TestTQueryInteger.TestTakeWhile;
begin
  CheckEquals(4, IntegerQuery.From(FIntegerCollection).TakeWhile(FFourOrLess).Count);
end;

procedure TestTQueryInteger.TestTake1;
begin
  CheckEquals(1, IntegerQuery.From(FIntegerCollection).Take(1).Count);
end;

procedure TestTQueryInteger.TestTake5Evens;
begin
  CheckEquals(2, IntegerQuery.From(FIntegerCollection).Take(5).Even.Count);
end;

procedure TestTQueryInteger.TestTakeBetweenUnboundQueries;
begin
  CheckEquals(5, IntegerQuery.From(FIntegerCollection).TakeBetween(IntegerQuery.Equals(4), IntegerQuery.Equals(9)).Count);
end;
...
begin
  ...
  for I in IntegerQuery.From(FIntegerCollection).TakeBetween(4, 7) do
  begin
    Inc(LPassCount);
    case LPassCount of
      1 : CheckEquals(4, I);
...
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).TakeWhile(FFalsePredicate).Count);
end;

procedure TestTQueryInteger.TestTakeWhileLessEqual4Evens;
begin
  CheckEquals(2, IntegerQuery.From(FIntegerCollection).TakeWhile(FFourOrLess).Even.Count);
end;

procedure TestTQueryInteger.TestTakeWhileTrue;
begin
  CheckEquals(FIntegerCollection.Count, IntegerQuery.From(FIntegerCollection).TakeWhile(FTruePredicate).Count);
end;

procedure TestTQueryInteger.TestTakeWhileUnboundQuery;
begin
  CheckEquals(4, IntegerQuery.From(FIntegerCollection).TakeWhile(IntegerQuery.LessThanOrEquals(4)).Count);
end;

procedure TestTQueryInteger.TestTakeWhileUnboundQueryEvens;
begin
  CheckEquals(2, IntegerQuery.From(FIntegerCollection).TakeWhile(IntegerQuery.LessThanOrEquals(4)).Even.Count);
end;

procedure TestTQueryInteger.TestTakeZero;
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).Take(0).Count);
end;

procedure TestTQueryInteger.TestFirst;
begin
  CheckEquals(2, IntegerQuery.From(FIntegerCollection).Even.First);
end;

procedure TestTQueryInteger.TestFirstOnEmpty;
begin
  ExpectedException := EEmptyResultSetException;
  IntegerQuery.From(FIntegerCollection).GreaterThan(1000).First;
  StopExpectingException;
end;

procedure TestTQueryInteger.TestIsEven;
begin
  CheckEquals(5, IntegerQuery.From(FIntegerCollection).Even.Count);
end;

procedure TestTQueryInteger.TestIsNegative;
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).Negative.Count);
  FIntegerCollection.Add(-1);
  FIntegerCollection.Add(0);
  FIntegerCollection.Add(-1);
  FIntegerCollection.Add(-10);
  FIntegerCollection.Add(-5);
  CheckEquals(4, IntegerQuery.From(FIntegerCollection).Negative.Count);
end;

procedure TestTQueryInteger.TestIsOdd;
begin
  CheckEquals(5, IntegerQuery.From(FIntegerCollection).Odd.Count);
end;

procedure TestTQueryInteger.TestIsPositive;
begin
  CheckEquals(10, IntegerQuery.From(FIntegerCollection).Positive.Count);
  FIntegerCollection.Add(-1);
  FIntegerCollection.Add(0);
  FIntegerCollection.Add(-1);
  FIntegerCollection.Add(-10);
...
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).Zero.Count);
  FIntegerCollection.Add(-1);
  FIntegerCollection.Add(0);
  FIntegerCollection.Add(-1);
  FIntegerCollection.Add(-10);
  FIntegerCollection.Add(-5);
  CheckEquals(1, IntegerQuery.From(FIntegerCollection).Zero.Count);
end;
...
begin
  ...
  for I in IntegerQuery
             .From(FIntegerCollection)
             .Where(IntegerQuery.Even.Predicate)
             .Map(FInc) do
  begin
    Inc(LPassCount);
    case LPassCount of
...
var
  Value : Integer;
begin
  Value := IntegerQuery.From(FIntegerCollection).Max;
  Check(Value = 10, 'Max should return 10');

  Value := IntegerQuery.From(FIntegerCollection).Odd.Max;
...
var
  Value : Integer;
begin
  Value := IntegerQuery.From(FIntegerCollection).Min;
  Check(Value = 1, 'Min should return 1');

  Value := IntegerQuery.From(FIntegerCollection).Even.Min;
  Check(Value = 2, 'Even.Min should return 2');
end;

procedure TestTQueryInteger.TestWhereNotEven;
begin
  CheckExpectedCountWithInnerCheck(IntegerQuery.From(FIntegerCollection).WhereNot(FEvenNumbers),
...
begin
  CheckExpectedCountWithInnerCheck(IntegerQuery.From(FIntegerCollection).WhereNot(IntegerQuery.Where(FEvenNumbers)),
                                   function (Value : Integer) : Boolean
                                   begin
                                    Result := Value mod 2 <> 0;
                                   end,
...
begin
  Check(SameValue(IntegerQuery.From(FIntegerCollection).Average, 5.1), 'Average should return 5.1');
  Check(SameValue(IntegerQuery.From(FIntegerCollection).Even.Average, 5.2), 'Even.Average should return 5.2');
end;

procedure TestTQueryInteger.TestAverageEmptyResultSet;
begin
  ExpectedException := EEmptyResultSetException;
  DummyDouble := IntegerQuery.From(FIntegerCollection).Zero.Average;
...
begin
  CheckEquals(FIntegerCollection.Count, IntegerQuery.From(FIntegerCollection).Count);
end;

procedure TestTQueryInteger.TestSkipEqualCount;
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).Skip(FIntegerCollection.Count).Count);
end;

procedure TestTQueryInteger.TestSkipGreaterThanCount;
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).Skip(FIntegerCollection.Count + 2).Count);
end;

procedure TestTQueryInteger.TestSkipLowerThanCount;
begin
  CheckEquals(2, IntegerQuery.From(FIntegerCollection).Skip(FIntegerCollection.Count - 2).Count);
end;

procedure TestTQueryInteger.TestSkipUntil;
begin
  CheckEquals(7, IntegerQuery.From(FIntegerCollection).SkipUntil(4).Count);
end;

procedure TestTQueryInteger.TestSkipUntilTakeUntil;
begin
  CheckEquals(5, IntegerQuery.From(FIntegerCollection).SkipUntil(4).TakeUntil(9).Count);
end;

procedure TestTQueryInteger.TestSkipUntilUnboundQuery;
begin
  CheckEquals(7, IntegerQuery.From(FIntegerCollection).SkipUntil(IntegerQuery.Equals(4)).Count);
end;

procedure TestTQueryInteger.TestSkipUntilUnboundQueryTakeUntilUnboundQuery;
begin
  CheckEquals(5, IntegerQuery.From(FIntegerCollection).SkipUntil(IntegerQuery.Equals(4)).TakeUntil(IntegerQuery.Equals(9)).Count);
end;

procedure TestTQueryInteger.TestSkipWhere;
begin
  CheckEquals(3, IntegerQuery.From(FIntegerCollection).Skip(5).Where(FEvenNumbers).Count);
end;

procedure TestTQueryInteger.TestSkipWhile;
begin
  CheckEquals(6, IntegerQuery.From(FIntegerCollection).SkipWhile(FFourOrLess).Count);
end;

procedure TestTQueryInteger.TestSkipWhileFalse;
begin
  CheckEquals(FIntegerCollection.Count, IntegerQuery.From(FIntegerCollection).SkipWhile(FFalsePredicate).Count);
end;

procedure TestTQueryInteger.TestSkipWhileTrue;
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).SkipWhile(FTruePredicate).Count);
end;

procedure TestTQueryInteger.TestSkipWhileUnboundQuery;
begin
  CheckEquals(6, IntegerQuery.From(FIntegerCollection).SkipWhile(IntegerQuery.LessThanOrEquals(4)).Count);
end;

procedure TestTQueryInteger.TestSkipWhileUnboundQueryTakeWhileUnbundQuery;
begin
  CheckEquals(4, IntegerQuery.From(FIntegerCollection).TakeWhile(IntegerQuery.LessThanOrEquals(8)).SkipWhile(IntegerQuery.LessThanOrEquals(4)).Count);
end;

procedure TestTQueryInteger.TestSkipZero;
begin
  CheckEquals(FIntegerCollection.Count, IntegerQuery.From(FIntegerCollection).Skip(0).Count);
end;

procedure TestTQueryInteger.TestSum;
begin
  CheckEquals(51, IntegerQuery.From(FIntegerCollection).Sum);
  CheckEquals(26, IntegerQuery.From(FIntegerCollection).Even.Sum);
end;

procedure TestTQueryInteger.TestWhereEven;
begin
  CheckEquals(5, IntegerQuery.From(FIntegerCollection).Where(FEvenNumbers).Count);
end;

procedure TestTQueryInteger.TestWhereAll;
begin
  CheckEquals(10, IntegerQuery.From(FIntegerCollection).Where(FTruePredicate).Count);
end;

procedure TestTQueryInteger.TestWhereTake;
begin
  CheckEquals(3, IntegerQuery.From(FIntegerCollection).Where(FEvenNumbers).Take(3).Count);
end;

procedure TestTQueryInteger.TestWhereNone;
begin
  CheckEquals(0, IntegerQuery.From(FIntegerCollection).Where(FGreaterThanTen).Take(3).Count);
end;

procedure TestTQueryInteger.TestWhereSkip;
begin
  CheckEquals(2, IntegerQuery.From(FIntegerCollection).Where(FEvenNumbers).Skip(3).Count);
end;
